...
def open_file():
    file_path = filedialog.askopenfilename(filetypes=[("C Files", "*.h")])
    if file_path:
...
def save_file():
    file_path = filedialog.asksaveasfilename(defaultextension=".h", filetypes=[("C Files", "*.h")])
    if file_path:
