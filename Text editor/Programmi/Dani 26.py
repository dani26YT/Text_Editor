...
def open_file():
    file_path = filedialog.askopenfilename(filetypes=[("Dani 26 Files", "*.Dani26")])
    if file_path:
...
def save_file():
    file_path = filedialog.asksaveasfilename(defaultextension=".dani26", filetypes=[("Dani 26 Files", "*.dani26")])
    if file_path:
